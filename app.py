...
if __name__ == "__main__":
    ...
    contracts = web3.eth.contract(address=address, abi=abi)       in API
    ...
    if chosenAlgorithm == 0:
        print("Chosen Algorithm: AES")
    elif chosenAlgorithm == 1:
        print("Chosen Algorithm: 3DES")
    elif chosenAlgorithm == 2:
        print("Chosen Algorithm: Blowfish")
        ...
        while(logged):
            try:
                ...
                if choice == 1:
                    ...
                    recordID = 0
                    try:
                        recordID = int(input("Input recordID: "))
                    except:
                        print("\nInvalid input.")
                        continue
                    ...
                    getKeyIndex = None
                    if accesscode == 'N':
                        getKeyIndex = contracts.functions.getKey(recipient_wallet, recordID).call()
                ...
                elif choice == 2: # Retrieve a record

                    currentAcct = get_currentAcct(contracts)
                    print("\nCurrent Account: " + str(currentAcct))               # Debugging
                    ...
                    if verified == 0: # if user has no permission to access record
                        ...
                        print('\nRecord ID: {}   Date: {}'.format(Record[0], Record[1]))
                    ...
                    if notif[2] == 'Read Access':
                        ...
                        print("\n")
                        print('No notification for specified record.')

                elif choice == 4: # Logout
                    p.dump(keys, open('/Users/earth/Downloads/THESIS/app_keys/keys.rtf','wb'))
                    logged = False

                elif choice == 5: # Logout and Exit
                    p.dump(keys, open('/Users/earth/Downloads/THESIS/app_keys/keys.rtf','wb'))
                    logged = False
                    valid = False
