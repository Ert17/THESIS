...
address = web3.toChecksumAddress('0xFfeEEE861bc521baC8cF4e31eD746819ccB5eFD1') # changes per deployment
...
if __name__ == "__main__":
    ...
    #contracts.functions.initialize().transact()
    ...
    while (valid):
        ...
        if choice == 1:
            ...
            if reqResult[0] == 1: #reqResult(0) == 1
                ...
                #print('Invoke AccessID:' + str(invokeResult))
                ...
                if(chosenAlgorithm == "AES"): #AES
                    ...
                    while not implemented:
                        ...
                        # keys[str(keysCount)] = TripleDES_key
                        # keysCount += 1
            ...
            # storeKey(accessID, public_key)
                ...
                print("All current keys after delete: " + str(keys))
                ...
                #print('Revoke AccessID:' + str(revokeResult))
                print(web3.toHex(revokeResult))

                # invalidateKeyResult = contracts.functions.invalidateKey(reqResult[1]).transact()
                # print(web3.toHex(invalidateResult))

                # debugging tool
                print("Keys after removing and invalidating key: " + str(keys))
            ...
            '''
            # MAKE SURE ACCOUNT RETRIEVING IS CHOSEN IN REMIX FIRST BEFORE CALLING THIS CHOICE
