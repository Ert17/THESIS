...
address = web3.toChecksumAddress('0x0d9693f26e71907edA3441CA82F0CE15A0882783') # changes per deployment
...
if __name__ == "__main__":
    ...
    while (valid):
        ...
        while(logged):
            # try:
            choice = int(input("Choices: 1. Create Request   2. Retrieve a Record   3. View Notification   4. Logout    5. Logout and Exit> "))
